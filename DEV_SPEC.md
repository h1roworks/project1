...
| 任务编号 | 任务名称 | 状态 | 完成日期 | 备注 |
|---------|---------|------|---------|------|
| B1 | LLM 抽象接口与工厂 | [x] | 2026-09-08 | 组1 |
| B2 | Embedding 抽象接口与工厂 | [x] | 2026-09-08 | 组1 |
| B3 | Splitter 抽象接口与工厂 | [x] | 2026-09-08 | 组1 |
| B4 | VectorStore 抽象接口与工厂 | [x] | 2026-09-08 | 组1 |
| B5 | Reranker 抽象接口与工厂（含 None 回退） | [x] | 2026-09-08 | 组1 |
| B6 | Evaluator 抽象接口与工厂 | [x] | 2026-09-08 | 组1 |
| B7.1 | OpenAI-Compatible LLM 实现 | [x] | 2026-09-08 | 组2 |
| B7.2 | Ollama LLM 实现 | [x] | 2026-09-08 | 组2 |
| B7.3 | OpenAI & Azure Embedding 实现 | [x] | 2026-09-08 | 组3 |
| B7.4 | Ollama Embedding 实现 | [x] | 2026-09-08 | 组3 |
| B7.5 | Recursive Splitter 默认实现 | [x] | 2026-09-08 | 组4 |
| B7.6 | ChromaStore 默认实现 | [x] | 2026-09-08 | 组4 |
| B7.7 | LLM Reranker 实现 | [x] | 2026-09-08 | 组5 |
| B7.8 | Cross-Encoder Reranker 实现 | [x] | 2026-09-08 | 组5 |
| B8 | Vision LLM 抽象接口与工厂集成 | [x] | 2026-09-08 | 组2 |
| B9 | Azure Vision LLM 实现 | [x] | 2026-09-08 | 组2 |

#### 阶段 C：Ingestion Pipeline MVP

| 任务编号 | 任务名称 | 状态 | 完成日期 | 备注 |
|---------|---------|------|---------|------|
| C1 | 定义核心数据类型/契约（Document/Chunk/ChunkRecord） | [x] | 2026-09-08 | |
| C2 | 文件完整性检查（SHA256） | [x] | 2026-09-08 | |
...
| G6 | Query 追踪页面 | [x] | 2026-09-14 | Query 关键词筛选、阶段耗时、Dense/Sparse 召回与 Rerank 排序对比；1 项专属测试通过 |
...
| 任务编号 | 任务名称 | 状态 | 完成日期 | 备注 |
|---------|---------|------|---------|------|
| I1 | E2E：MCP Client 侧调用模拟 | [x] | 2026-09-14 | 子进程启动真实 stdio MCP Server；官方 MCP Client 完成 tools/list 与 query_knowledge_hub 调用，并验证 structured citations |
| I2 | E2E：Dashboard 冒烟测试 | [x] | 2026-09-14 | 使用 Streamlit AppTest 遍历六个导航页面；注入确定性测试数据并验证无 Python 异常 |
| I3 | 完善 README（运行说明 + MCP + Dashboard） | [x] | 2026-09-14 | 补齐手动安装、API Key/Provider、PDF 摄取、查询、Dashboard、MCP 客户端配置、测试命令和常见排查说明 |
| I4 | 清理接口一致性（契约测试补齐） | [x] | 2026-09-14 | 补齐 VectorStore metadata 删除命中/未命中及不支持能力边界；补齐 Reranker 禁用/空配置回退与列表隔离；补齐 CustomEvaluator 重复 ID 与 trace 参数边界 |
| I5 | 全链路 E2E 验收 | [ ] | | |
